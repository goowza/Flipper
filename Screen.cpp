...
// @Fonctions transfert data en I2C
...
// Constructeur de notre screen
Screen::Screen(){		
}

//@Fonction d'initialisation de l'écran et de la comm d'I2C
...
// Fonction pour écrire sur l'écran  avec un string donné
...
// Fonction d'affichage du score d'un player
...
// Fonction pour retourner le curseur au début de l'écran
void Screen::home(){
    i2Cmd (m_i2c_lcd_control, LCD_RETURNHOME);
    usleep(4500);	
}

// Fonction pour choisir la position du curseur sur l'écran
